...
/*
 * The most interesting part of the code is the ConnectedThread class (line 379)
 */
public class BluetoothService {
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                Log.e("AcceptThread: ", "Trying very hard");
                try {
    ...
    /*
     * The biggest part of the communication happens after the thread is connected
     * (in the MultiplayerGameActivity)
     * This isn't necessary in the 'double player' case, but makes multiplayer easier
     * The message format is:
     * message_code | message | 4-byte userId | END_MESSAGE byte
     */
